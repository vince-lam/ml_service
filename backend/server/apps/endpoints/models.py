...
class MLAlgorithmStatus(models.Model):
    '''
    The MLAgorithmStatus represent status of the MLAlgorithm which can change during the time.
...
class MLRequest(models.Model):
    ...
    Attributes:
        ...
        repsonse: The response of the ML algorithm in JSON format.
        feedback: The feedback about the response in JSON format.
        created_at: The date when request was created.
        parent_algorithm: The reference to MLagorithm used to compute response.
    '''
